package net.flashpunk.utils
{
	...
	public class MaskInput
	{
		...
		public static function mouseDown(entity:Entity, onlyOnTop:Boolean = true):Boolean
		{
			if(!Input.mouseDown) return false;
			return mouseIsOver(entity, onlyOnTop);
		}
		
		public static function mouseUp(entity:Entity, onlyOnTop:Boolean = true):Boolean
		{
			if(!Input.mouseUp) return false;
			return mouseIsOver(entity, onlyOnTop);
		}
		
		public static function mousePressed(entity:Entity, onlyOnTop:Boolean = true):Boolean
		{
			if(!Input.mousePressed) return false;
			return mouseIsOver(entity, onlyOnTop);
		}
		
		public static function mouseReleased(entity:Entity, onlyOnTop:Boolean = true):Boolean
		{
			if(!Input.mouseReleased) return false;
			return mouseIsOver(entity, onlyOnTop);
		}
		
		public static function mouseIsOver(entity:Entity, onlyOnTop:Boolean = true):Boolean
		{
